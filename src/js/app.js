App = {
  ...
  initContract: function () {
    ...
    $.getJSON('FriendlyCrowdsale.json', function(data) {
      App.contracts.FriendlyCrowdsale = TruffleContract(data);
      App.contracts.FriendlyCrowdsale.setProvider(App.web3Provider);
    });
